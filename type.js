...
'use strict';
  ...
  var options = {
          ...
          acceleration: 0.03   , // Cells per second per second
       speedLossOnSlow: 0.2     , // Cells per second
             gridWidth: 30      , // Cells
            gridHeight: 20      , // Cells
    initialColumnCount: 10       , // Cells (columns)
         probabilities: {         // [0, 1]
           score: 1 / 10  ,
            slow: 1 / 120 ,
           block: 1 / 60  ,
...
//game variable/renderer
  ...
  Game.initialize = function(options, renderer) {
    ...
    // Clear some room around the player for the crosshair
